    ...
    <>
      ...
      <MenuMobileContainer clk={click}>
        <MenuMobileList>
          ...
          <MenuMobileListItem onClick={() => setServiceClick(!serviceClick)}>
            Services{" "}
          </MenuMobileListItem>
          <Link to="/contact">
            <MenuMobileListItem onClick={() => setClick(!click)}>
              Contact Us
            </MenuMobileListItem>
          </Link>
          <Link to="/about">
...
const MenuMobileContainer = styled.div`
  ...
  align-items: center;
  ${(props) =>
    props.clk ? "transform:translateX(0%);" : "transform:translateX(-100%);"}
  display:none;
  @media (max-width: 900px) {
    display: flex;
  }
